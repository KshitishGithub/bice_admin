...
$Addobj->rawsql("SELECT * FROM registration r INNER JOIN personal_details p ON r.s_id = p.s_id INNER JOIN photo_signature s ON r.s_id = s.s_id LEFT JOIN comunication m ON r.s_id = m.s_id WHERE r.s_id = $id");
...
echo '<div class="modal-header bg-warning">
                    <h5 class="modal-title" id="staticBackdropLabel">Pending Students:</h5>
