...
echo '<div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title" id="staticBackdropLabel">Old Students Fees Details</h5>
                        ...
                        <div class="form-group">
                            <div class="table-responsive">
                                ...
                                <thead class="table-secondary">
                                   ...
                                   $obj->rawsql("SELECT * FROM old_students_months_2023 o LEFT JOIN old_students_fees_2023 f ON o.id = f.id WHERE o.s_id = $id");
                                   ...
                                   $obj->rawsql("SELECT * FROM old_students_fees_2023 f LEFT JOIN old_students_months_2023 o ON f.id = o.id WHERE o.s_id = $id");
